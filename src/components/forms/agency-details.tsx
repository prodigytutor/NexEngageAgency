  ...
  const handleDeleteAgency = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Deleting your agency and all your subaccount",
      });
      router.refresh();
    } catch (error) {
      toast({
    ...
    <AlertDialog>
      <Card className="w-full mt-4">
        <CardHeader>
          ...
          <CardDescription>
            Lets create an agency for your business. You cam edit agency
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)}>
              ...
              <FormField
                ...
                render={({ field }) => {
                  return (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border gap-4 p-4 mt-4">
                      <div>
